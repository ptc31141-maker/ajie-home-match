...
> &
  Partial<
    Pick<
      StationKnowledge,
      "price" | "notes" | "verification" | "source" | "sourceUrl"
    >
  >;
...
const stationDetails: Record<string, StationDetail> = {
  ...
  建设一路: {
    district: "萧山区 · 市北",
    communities: ["国之璟府", "花屿观澜里", "御庭园", "展望轩"],
    apartments: ["欢腾国际", "东方壹号公寓"],
  },
  建设三路: {
    district: "萧山区 · 市北",
    communities: [
    ...
    notes: ["你的笔记标注：建设三路低预算优先看青集社"],
    verification: "师傅已核对",
    source: "你的性价比笔记＋手写沿线表＋公开房源平台",
  },
  振宁路: {
    district: "萧山区 · 宁围",
    communities: [
    ...
    apartments: ["奥体华悦城", "海杰德大厦", "百富众望大厦", "港汇中心"],
    notes: ["地铁口优先推：大成名座、南岸明珠、宁安大厦"],
    verification: "师傅已核对",
    source: "你的性价比笔记＋2号线手写沿线表＋公开房源平台",
  },
  飞虹路: {
    district: "萧山区 · 钱江世纪城",
    communities: [
